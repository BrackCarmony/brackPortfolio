	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "ul",
	        { style: this.styles.linkCollection },
	        React.createElement(
	          "a",
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement("img", { style: { 'maxWidth': '60px', 'maxHeight': '60px' }, src: "images/Logo_D3.svg.png" }),
	          React.createElement("img", { style: { 'maxWidth': '60px', 'maxHeight': '60px' }, src: "images/square.jpg" }),
	  ...
	  gotoFace: function gotoFace(face) {
	  ...
	  randomSide: function randomSide() {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var listItems = this.props.items.map(function (item, index) {
	      return React.createElement(
	        "li",
	        { key: index + "str", className: "list-group-item", style: _this.styles.listGroup },
	        React.createElement(
	          "span",
	          { style: _this.styles.todoItem, onClick: _this.props.remove.bind(null, index) },
	          item
	        ),
	        React.createElement(
	          "span",
	          { style: _this.styles.removeItem, onClick: _this.props.remove.bind(null, index) },
	          "X"
	        )
	      );
	    }); //*/;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddItem = __webpack_require__(158);
	var List = __webpack_require__(159);
	var VerticleDotDistribution = __webpack_require__(161);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { style: this.styles.chartDiv },
	      React.createElement(
	        "div",
	        { style: this.styles.center },
	        React.createElement(
	          "div",
	          { style: this.styles.parentList },
	          React.createElement(
	            "div",
	            { style: this.styles.D3Chart },
	            React.createElement(VerticleDotDistribution, { points: this.state.list, r: "1" })
	          ),
	          React.createElement(
	            "div",
	...
	module.exports = React.createClass({
	    ...
	    if (this.props.points) {
	      ...
	      return this.props.points.map(function (item, index) {
	        return React.createElement('circle', {
	          key: index + "str",
	          cx: (index + 1) / (count + 1) * _this.props.boxWidth,
	          cy: (item - _this.props.minY) / (_this.props.maxY - _this.props.minY) * _this.props.boxHeight,
	          r: _this.props.r
	        });
	      });
	    }
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('rect', { x: this.props.boxWidth / 2 - .25, y: '0', width: '.5', height: this.props.boxHeight }),
	      React.createElement('rect', { x: '0', y: '0', width: this.props.boxWidth, height: '.25' }),
	      React.createElement('rect', { x: '0', y: this.props.boxHeight - .25, width: this.props.boxWidth, height: '.25' }),
	      this.makeDots()
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  styles: {
	    ...
	    selectFace: [{ transform: 'translateZ(-300px) rotateY(   0deg)  ' }, { transform: 'translateZ(-300px) rotateX(-180deg) ' }, { transform: 'translateZ(-300px) rotateY( -90deg) ' }, { transform: 'translateZ(-300px) rotateY(  90deg) ' }, { transform: 'translateZ(-300px) rotateX( -90deg) ' }, { transform: 'translateZ(-300px) rotateX(  90deg) ' }]
